...
| 3O | [`sim_fidelity_phase_3o.md`](sim_fidelity_phase_3o.md) | Matched-board survivor-mechanic attribution (`3o_v1`): **HOLD `start_stats_synth_dominates`** — 3N B +0.688 reproduced; T5/T6 class-(3) 1033; start-stats **121%** of T5/T6 B (synth 118%, recruit 0); residual 0; next traces why matched-tier boards allocate synth differently; do not change `_hero_damage`; #29/#33–#47/#50–#60 HOLD |
| 3P | [`sim_fidelity_phase_3p.md`](sim_fidelity_phase_3p.md) | Synthetic-pool allocation-input (`3p_v1`): **HOLD `timing_membership_dominates`** — T1 22.2→14.6 / T3 7.1→19.2 reproduced; paint identity holds; timing/membership **98.6%** (last event = play, both arms); pool 0.6% / weight 0 / rounding 0.8%; next traces the play lifecycle sticky-vs-paint; do not retune scaling; #29/#33–#47/#50–#61 HOLD |
| 3Q | [`sim_fidelity_phase_3q.md`](sim_fidelity_phase_3q.md) | Play-lifecycle sticky-vs-repaint (`3q_v1`): **HOLD `ranked_residual_needs_next_observable`** — T1 22.2→14.6 / T3 7.1→19.2 reproduced; last play open-slot both arms; same-state paint **7.2%** / lifecycle **44.8%** / subsequent scaling **48.0%** / residual 0; next ranks leftover (scale-sync, then open-slot sticky); do not retune scaling; #29/#33–#47/#50–#62 HOLD |
| 3R | [`sim_fidelity_phase_3r.md`](sim_fidelity_phase_3r.md) | Post-play scale-sync input/timing (`3r_v1`): **HOLD `membership_allocation_dominates`** — 3Q 48.0% scaling reproduced; membership-conditioned allocation **97.0%** / rounding 1.9% / input 1.2% / timing 0; next is the open-slot lifecycle lane; do not retune scaling; #29/#33–#47/#50–#63 HOLD |
| 3S | [`sim_fidelity_phase_3s.md`](sim_fidelity_phase_3s.md) | Open-slot board-formation (`3s_v1`): **HOLD `pre_play_membership_dominates`** — 3Q 44.8% lifecycle reproduced; pre-play composition **100%** (identities match, incumbent synth already differs); incoming / opening / order 0; 3R membership increment **100%** this tag; earliest split **T5**; do not rewrite 2Q; #29/#33–#47/#50–#64 HOLD |
