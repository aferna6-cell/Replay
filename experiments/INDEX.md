...
| 3O | [`sim_fidelity_phase_3o.md`](sim_fidelity_phase_3o.md) | Matched-board survivor-mechanic attribution (`3o_v1`): **DEV pending** — T5/T6 class-(3) nested Kitagawa of 3N B=+0.688 into start-stats / slot / target / keywords / teammate / residual; do not change `_hero_damage`; #29/#33–#47/#50–#60 HOLD |
